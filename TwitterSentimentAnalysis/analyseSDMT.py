...
def main():
    ...
    posTweetFile=open('../SentimentCounts/sdmtPositiveTweets.json','w')
    negTweetFile=open('../SentimentCounts/sdmtNegativeTweets.json','w')
    neuTweetFile=open('../SentimentCounts/sdmtNeutralTweets.json','w')
