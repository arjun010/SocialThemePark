...
def createWordCountFile():
    ...
    with open('hulkride_WordCount.txt') as fin:
    ...
    optFile = open('../WordCounts/hulkride.csv', 'w')
...
def main():
    ...
    inp = open('../TwitterSearch/hulkride.txt','r')
    ...
    with open('../SentimentCounts/hulkride.json', 'w') as outfile:
