...
def createWordCountFile():
    ...
    with open('batman_WordCount.txt') as fin:
    ...
    optFile = open('../WordCounts/batman.csv', 'w')
...
def main():
    ...
    with open('../SentimentCounts/batmanPositiveTweets.json', 'w') as outfile:
        json.dump(posTweets, outfile,indent=0)
    outfile.close()
    with open('../SentimentCounts/batmanNegativeTweets.json', 'w') as outfile:
        json.dump(negTweets, outfile,indent=0)
    outfile.close()
    with open('../SentimentCounts/batmanNeutralTweets.json', 'w') as outfile:
