...
def main():
    ...
    posTweetFile=open('../SentimentCounts/batmanPositiveTweets.json','w')
    negTweetFile=open('../SentimentCounts/batmanNegativeTweets.json','w')
    neuTweetFile=open('../SentimentCounts/batmanNeutralTweets.json','w')
