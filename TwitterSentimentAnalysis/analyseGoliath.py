...
def createWordCountFile():
    ...
    opt = open('goliath_WordCount.txt','w')
    ...
    with open('goliath_WordCount.txt') as fin:
    ...
    optFile = open('../WordCounts/goliath.csv', 'w')
...
def main():
    ...
    inp = open('../newSearch/goliath.json','r')
    ...
    with open('../SentimentCounts/goliathPositiveTweets.json', 'w') as outfile:
        json.dump(posTweets, outfile,indent=0)
    outfile.close()
    with open('../SentimentCounts/goliathNegativeTweets.json', 'w') as outfile:
        json.dump(negTweets, outfile,indent=0)
    outfile.close()
    with open('../SentimentCounts/goliathNeutralTweets.json', 'w') as outfile:
    ...
    with open('../SentimentCounts/goliath.json', 'w') as outfile:
