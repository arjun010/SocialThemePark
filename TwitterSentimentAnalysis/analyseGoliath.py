...
def main():
    ...
    posTweetFile=open('../SentimentCounts/goliathPositiveTweets.json','w')
    negTweetFile=open('../SentimentCounts/goliathNegativeTweets.json','w')
    neuTweetFile=open('../SentimentCounts/goliathNeutralTweets.json','w')
