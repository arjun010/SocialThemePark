...
def main():
    ...
    posTweetFile=open('../SentimentCounts/spacemountainPositiveTweets.json','w')
    negTweetFile=open('../SentimentCounts/spacemountainNegativeTweets.json','w')
    neuTweetFile=open('../SentimentCounts/spacemountainNeutralTweets.json','w')
