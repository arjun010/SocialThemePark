...
def createWordCountFile():
    ...
    with open('spacemountain_WordCount.txt') as fin:
    ...
    optFile = open('../WordCounts/spacemountain.csv', 'w')
...
def main():
    ...
    inp = open('../newSearch/spacemountain.json','r')
    ...
    with open('../SentimentCounts/spacemountainPositiveTweets.json', 'w') as outfile:
        json.dump(posTweets, outfile,indent=0)
    outfile.close()
    with open('../SentimentCounts/spacemountainNegativeTweets.json', 'w') as outfile:
        json.dump(negTweets, outfile,indent=0)
    outfile.close()
    with open('../SentimentCounts/spacemountainNeutralTweets.json', 'w') as outfile:
    ...
    with open('../SentimentCounts/spacemountain.json', 'w') as outfile:
